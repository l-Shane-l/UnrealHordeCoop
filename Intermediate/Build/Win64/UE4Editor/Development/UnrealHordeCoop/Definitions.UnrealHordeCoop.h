...
#define UE_PROJECT_NAME UnrealHordeCoop
#define UE_TARGET_NAME UnrealHordeCoopEditor
#define UE_MODULE_NAME "UnrealHordeCoop"
...
#define UNREALHORDECOOP_API DLLEXPORT
